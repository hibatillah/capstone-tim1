      ...
      {user === "admin" || user === "supplier" ? (
        <div className="relative w-full min-h-screen flex gap-x-5 py-3 pl-3 pr-5 bg-grey-light dark:bg-black-light font-outfit">
          ...
          <div
            ...
            } fixed top-0 w-1/5 py-5 pl-5 pr-4 h-screen bg-white dark:bg-black-dark shadow-lg shadow-black-light transition-all duration-500 ease-in-out`}
          >
            <div className="flex justify-between items-center">
              <h3 className="font-semibold text-tertiary dark:text-white">
                Notification
              </h3>
              <div onClick={handleNotif} className="p-1 rounded hover:bg-grey-light cursor-pointer active:bg-primary-light group">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke-width="2"
                  class="w-5 h-5 stroke-tertiary group-active:stroke-white"
                >
                  <path
